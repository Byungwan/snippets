...
print("init-only: expected iseg 0, actual " + str(iseg), end="")
if iseg == 0:
    print(' ... OK')
else:
    print(' ... NG')
...
print("init-sidx: expected iseg 1, actual " + str(iseg), end="")
if iseg == 1:
    print(' ... OK')
else:
    print(' ... NG')
...
print("test_out: expected iseg 1, actual " + str(iseg), end="")
if iseg == 1:
    print(' ... OK')
else:
    print(' ... NG')
